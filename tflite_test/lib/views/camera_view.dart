...
import 'package:tflite_test/utils/isolate_utils.dart';

// 실시간으로 카메라 뷰를 생성하고 관리
...
class _CameraViewState extends State<CameraView> with WidgetsBindingObserver {
  ...
  onLatestImageAvailable(CameraImage cameraImage) async {
    if (classifire?.interpreter != null && classifire?.labels != null) {
      ...
      var isolateData = IsolateData(cameraImage,
          classifire?.interpreter?.address ?? 0, classifire?.labels ?? []);
      // 추론 결과 반환
